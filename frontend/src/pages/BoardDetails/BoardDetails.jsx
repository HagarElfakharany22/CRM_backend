...
export default function BoardDetails() {
    ...
    return(
        <div className={`${styles.bg_gredient} container p-0 vh-100 `}>
            <div className={`${styles.boardNav} ${styles.bg_dark_transparent} p-2 text-white d-flex align-items-center justify-content-between`}>
                <div><h4>{data.owner.name}</h4></div>
            </div>
        </div>
